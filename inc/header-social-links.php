<?php
    ...
    class talib_social_icons_links extends WP_Widget {
        ...
        public function __construct() {
            parent::__construct(
                ...
                __( 'TALIB: Social Icons', 'reveal' ),                 // Name
                array( 'description' => __( 'Social Icons', 'reveal' ) ) // Args
            );
        }
    ...
    foreach ( $social_icons as $sci ) {
        ...
        <?php
            echo wp_kses_post( $after_widget );
                ...
                ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title:', 'reveal' );?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"
                   name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text"
                   value="<?php echo esc_attr( $title ); ?>"/>
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'classname' ) ); ?>"><?php _e( 'CSS Class name:', 'reveal' );?></label>
        ...
        <?php foreach ( $social_icons as $sci ) {
                    ?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( $sci ) ); ?>"><?php echo esc_html( ucfirst( $sci ) . " " . __( 'URL', 'reveal' ) ); ?>
                    : </label>
                <br/>
        ...
        <?php
            ...
            function talib_social_icons_widget() {
                register_widget( 'talib_social_icons_links' );
            }

        add_action( 'widgets_init', 'talib_social_icons_widget' );
